...
YHStrings.Add( (m="YHCPerk_Scientist",k="PharmingDescription",s="Darted zeds release healing clouds upon death") )
YHStrings.Add( (m="YHCPerk_Scientist",k="Overdose",s="Overdose") )
YHStrings.Add( (m="YHCPerk_Scientist",k="OverdoseDescription",s="Darted zeds will explode upon death") )
...
YHStrings.Add( (m="YHCPerk_Scientist",k="ZedWhispererDescription",s="Darting Zeds will de-rage or disable some special moves") )
...
YHStrings.Add( (m="YHProj_ZedTimeGrenade",k="ItemName",s="Time Decompression Grenade") )
YHStrings.Add( (m="YHProj_ZedTimeGrenade",k="ItemDescription",s="-Triggers Zed Time. Amazing stuff.") )
