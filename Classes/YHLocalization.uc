...
YHStrings.Add( (m="YHCPerk_Scientist",k="BobbleheadsDescription",s="Darting Zeds will inflate them. Headshots most effective.") )
YHStrings.Add( (m="YHCPerk_Scientist",k="Sensitive",s="Sensitive") )
YHStrings.Add( (m="YHCPerk_Scientist",k="SensitiveDescription",s="Darting Zeds will decrease damage by 20% and resistance by 20%. Headshots most effective.") )
YHStrings.Add( (m="YHCPerk_Scientist",k="Pharming",s="Pharming") )
YHStrings.Add( (m="YHCPerk_Scientist",k="PharmingDescription",s="Darted zeds release healing clouds upon death. Headshots most effective.") )
