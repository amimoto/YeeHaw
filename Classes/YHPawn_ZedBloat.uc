...
defaultproperties
{
    ...
    IncapSettings(YHAF_YourMineMine)=(Vulnerability=(0.5, 1.0, 0.5, 0.5, 0.5),Duration=60.0,Cooldown=5.0)
    IncapSettings(YHAF_SmellsLikeRoses)=(Vulnerability=(0.5, 1.0, 0.5, 0.5, 0.5),Duration=60,Cooldown=5.0)
